              ...
              <div className="text-white">
                  <div className="flex p-2  bg-gray-800">
                      <div className="flex flex-col py-3 px-2 items-center">
                          <p className="text-2xl text-white font-bold">AfricaConnect</p> 
                      ...
                      <ul className="mt-6 leading-10">
                          ...
                          {/* x-data="{ Open : false  }" */}
                              <div className="inline-flex items-center justify-between w-full text-base font-semibold transition-colors duration-150 text-gray-500  hover:text-yellow-400 cursor-pointer"
                                  ...
                                  <span
                                      className="inline-flex items-center  text-sm font-semibold text-white hover:text-green-400">
                                      <svg className="h-6 w-6" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"  
                                            viewBox="0 0 512 512" >
                          ...
                          {/* x-data="{ Open : false  }" */}
                              <div className="inline-flex items-center justify-between w-full text-base font-semibold transition-colors duration-150 text-gray-500  hover:text-yellow-400 cursor-pointer"
                                  ...
                                  <span
                                      className="inline-flex items-center  text-sm font-semibold text-white hover:text-green-400">
                                      <svg width="800px" className="h-6 w-6" height="800px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><defs></defs>
                                      <rect className="a" x="4.5" y="9.5" width="39" height="29" rx="3"/><line className="a" x1="4.5" y1="16.5" x2="43.5" y2="16.5"/><line className="a" x1="33.5" y1="34.5" x2="33.5" y2="32.5"/><line className="a" x1="36.5" y1="34.5" x2="36.5" y2="32.5"/><line className="a" x1="39.5" y1="34.5" x2="39.5" y2="32.5"/></svg>
                          ...
                          {/* x-data="{ Open : false  }" */}
                              <div className="inline-flex items-center justify-between w-full text-base font-semibold transition-colors duration-150 text-gray-500  hover:text-yellow-400 cursor-pointer"
                                  ...
                                  <span
                                      className="inline-flex items-center  text-sm font-semibold text-white hover:text-green-400">
                                      <svg fill="#000000" className="h-6 w-6" height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" 
	 viewBox="0 0 512 512" >
<g>
	<g>
                          ...
                          {/* x-data="{ Open : false  }" */}
                              <div className="inline-flex items-center justify-between w-full text-base font-semibold transition-colors duration-150 text-gray-500  hover:text-yellow-400 cursor-pointer"
                                  >
                                      {/* x-on:click="Open = !Open" */}
                                  <span
                                      className="inline-flex items-center  text-sm font-semibold text-gray-300 hover:text-green-400">
                    ...
                    <div className="text-white">
                        <div className="flex p-2  bg-gray-800">
                            <div className="flex py-3 px-2 items-center">
                                <p className="text-2xl text-green-500 font-semibold">AfricaConnect</p> 
                                <br/>
